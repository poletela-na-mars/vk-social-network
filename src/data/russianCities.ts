import { City } from '../types/russianCitiesTypes';
...
const parseRussianCities = JSON.parse(russianCities);
const citiesSet: Set<string> = new Set(parseRussianCities.cities.map((city: City) => city.name));
export const cities: readonly string[] = Array.from(citiesSet);
